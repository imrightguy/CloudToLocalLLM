...
# Zoidbot - Google Cloud Run Deployment Script
# This script builds and deploys Zoidbot services to Google Cloud Run
#
# Prerequisites:
...
main() {
    ...
    log_info "Starting Zoidbot deployment to Google Cloud Run..."
