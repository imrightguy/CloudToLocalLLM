...
# Zoidbot Version Management Utility
...
#
# Zoidbot Semantic Versioning Strategy:
#
...
show_version_info() {
    ...
    echo -e "${CYAN}=== Zoidbot Version Information ===${NC}"
...
main() {
    case "${1:-}" in
        ...
        "help"|"--help"|"-h"|"")
            ...
            echo ""
            echo "Zoidbot Semantic Versioning Strategy:"
            echo ""
