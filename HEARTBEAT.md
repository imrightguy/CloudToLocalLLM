...
- [ ] **Git Repository Bloat**: The current shallow clone is small, but the full-history repo may still need history cleanup later if large binaries are reintroduced.
