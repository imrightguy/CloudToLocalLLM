...
class OpenClawDashboardService extends ChangeNotifier {
  ...
  static const String _connectionEventsKey = 'openclaw_connection_events';
  ...
  OpenClawDashboardService() : _settings = OpenClawDashboardSettings.fromPreferences(
      ...
      if (agent is Map) {
        ...
        if (_agentStatuses.containsKey(id)) {
          ...
          if (existingStatus.status != newStatus.status) {
            ...
            _lifecycleEventsController.add(AgentLifecycleEvent(
                  agentId: id,
