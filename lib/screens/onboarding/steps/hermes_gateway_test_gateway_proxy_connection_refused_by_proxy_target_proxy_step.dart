library screens.onboarding.steps.hermes_gateway_test_gateway_proxy_connection_refused_by_proxy_target_proxy_step;
...
final Logger _log = Logger('HermesGatewayTestGatewayProxyConnectionRefusedByProxyTargetProxyStep');

class HermesGatewayTestGatewayProxyConnectionRefusedByProxyTargetProxyStep extends StatefulWidget {
  @override
  State<HermesGatewayTestGatewayProxyConnectionRefusedByProxyTargetProxyStep> createState() =>
...
class _HermesGatewayTestGatewayProxyConnectionRefusedByProxyTargetProxyState
    extends State<HermesGatewayTestGatewayProxyConnectionRefusedByProxyTargetProxyStep> {
  @override
