library screens.onboarding.steps.hermes_gateway_test_gateway_proxy_connection_aborted_by_proxy_target_proxy_proxy_proxy_proxy_proxy_step;
...
final Logger _log = Logger('HermesGatewayTestGatewayProxyConnectionAbortedByProxyTargetProxyProxyProxyProxyProxyStep');

class HermesGatewayTestGatewayProxyConnectionAbortedByProxyTargetProxyProxyProxyProxyProxyStep extends StatefulWidget {
  @override
  State<HermesGatewayTestGatewayProxyConnectionAbortedByProxyTargetProxyProxyProxyProxyProxyStep> createState() =>
...
class _HermesGatewayTestGatewayProxyConnectionAbortedByProxyTargetProxyProxyProxyProxyProxyState
    extends State<HermesGatewayTestGatewayProxyConnectionAbortedByProxyTargetProxyProxyProxyProxyProxyStep> {
  @override
