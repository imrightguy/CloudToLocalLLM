...
class _RegisterScreenState extends State<RegisterScreen> {
      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final form = _buildRegisterForm(context, theme);
            ...
            if (isDesktop) {
              return AuthDesktopLayout(
                ...
                subtitle:
                    'Rejoignez ImmoGestion depuis un espace de connexion qui respire enfin sur grand écran.',
                badge: 'Ouverture de compte',
                bullets: const [
                  'Préparez votre accès avant d’entrer dans le tableau de bord',
                  'Des champs plus lisibles sur les écrans de bureau',
                  'Retour immédiat vers l’espace sécurisé si le compte existe déjà',
                ],
                child: form,
              );
            }
  ...
  Widget _buildRegisterForm(BuildContext context, ThemeData theme) {
    return Form(
      key: _formKey,
      child: Column(
