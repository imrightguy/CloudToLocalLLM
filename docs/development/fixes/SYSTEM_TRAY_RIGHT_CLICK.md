...
The system tray icon in Zoidbot was not responding to right-click events on Windows, preventing users from accessing the context menu with options like "Show", "Hide", "Settings", and "Quit".
