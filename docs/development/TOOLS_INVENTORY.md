...
This document provides a comprehensive audit of all available tools within both the Model Context Protocol (MCP) framework and the command-line interface (CLI) environment for the Zoidbot project.
