...
/// Service for managing desktop windows
class WindowManagerService {
  ...
  Future<List<WindowInfo>> getWindows() async {
    if (!_isInitialized) {
      throw StateError('WindowManagerService not initialized');
    }

    try {
      final result = await _channel.invokeMethod('getWindows');
      if (result is List) {
        return result.map((w) => WindowInfo(
          id: w['id'] as String,
      ...
      debugPrint('Failed to get windows: $e');
      return [];
    }
  }
  ...
  Future<bool> focusWindow(String windowId) async {
    ...
    try {
      final result = await _channel.invokeMethod('focusWindow', {'windowId': windowId});
      return result == true;
    } catch (e) {
  ...
  Future<bool> moveWindow(String windowId, int x, int y) async {
    ...
    try {
      ...
      debugPrint('Failed to move window: $e');
      return false;
    }
  }
  ...
  Future<bool> minimizeWindow(String windowId) async {
    ...
    try {
      final result = await _channel.invokeMethod('minimizeWindow', {'windowId': windowId});
      return result == true;
    } catch (e) {
  ...
  Future<bool> maximizeWindow(String windowId) async {
    ...
    try {
      final result = await _channel.invokeMethod('maximizeWindow', {'windowId': windowId});
      return result == true;
    } catch (e) {
  ...
  Future<bool> closeWindow(String windowId) async {
    ...
    try {
      final result = await _channel.invokeMethod('closeWindow', {'windowId': windowId});
      return result == true;
    } catch (e) {
