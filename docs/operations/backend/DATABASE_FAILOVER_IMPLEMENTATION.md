...
1. Check primary database is running: `psql -h primary.example.com -U postgres -d zoidbot -c "SELECT 1"`
...
3. Check standby health: `psql -h standby.example.com -U postgres -d zoidbot -c "SELECT 1"`
