...
* chore: Rebranded project to 'Zoidbot' across all platforms and documentation
* chore: Updated all Dart imports to use 'package:zoidbot'
...
* chore: Renamed various configuration files and directories to match Zoidbot branding
...
* fix: use existing zoidbot-swarm VM in centralus as requested (ce3d562d)
...
* fix: correctly update vm name to zoidbot-swarm-eastus to resolve nic collision (9f61f984)
* chore: automated version bump to 10.1.124 [skip ci] (547a9b30)
* fix: rename vm to zoidbot-swarm-eastus to resolve nic location conflict and update workflow references (3ccfd69b)
...
* fix: inject zoidbot-secrets into cluster from github secrets (cb152ba5)
...
*   Fix ArgoCD 502 errors: enable HA deployment, remove insecure mode, fix Ingress host to zoidbot.online, add TLS configuration.
...
### Bug Fixes
*   Fix ArgoCD 502 errors: enable HA deployment, remove insecure mode, fix Ingress host to zoidbot.online, add TLS configuration (8d30de3)
*   Fix ArgoCD cloudflared configuration to use HTTP instead of HTTPS (61f673c)
*   Resolve grep option error in build pipeline (485f36c)
...
- Ensured actions/checkout is executed before gh commands in orchestrator.
- Fixed ArgoCD cloudflared configuration to use HTTP instead of HTTPS.
- Fixed ArgoCD 502 errors: enable HA deployment, remove insecure mode, fix Ingress host to zoidbot.online, add TLS configuration.
